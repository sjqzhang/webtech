...
$ git show [master@{yesterday](http://docs.pythontab.com/github/gitbook/Git-Tools/mailto:master%40%7Byesterday)}
...
需要注意的是，引用日志信息只存在于本地——这是一个记录你在你自己的仓库里做过什么的日志。其他人拷贝的仓库里的引用日志不会和你的相同；而你新克隆一个仓库的时候，引用日志是空的，因为你在仓库里还没有操作。git show [HEAD@{2.months.ago](http://docs.pythontab.com/github/gitbook/Git-Tools/mailto:HEAD%40%7B2.months.ago)} 这条命令只有在你克隆了一个项目至少两个月时才会有用——如果你是五分钟前克隆的仓库，那么它将不会有结果返回。
...
![http://docs.pythontab.com/github/gitbook/Git-Tools/../_images/18333fig0601-tn.png](http://docs.pythontab.com/github/gitbook/Git-Tools/../_images/18333fig0601-tn.png)图 6-1. 范围选择的提交历史实例
