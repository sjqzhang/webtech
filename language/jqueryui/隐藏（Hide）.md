 ...
 如需了解更多有关 .hide() 方法的细节，请查看 API 文档 [.hide()](http://www.w3cschool.cc/jqueryui/api-hide.html)。
...
```
 [查看演示](http://www.w3cschool.cc/try/tryit.php?filename=jqueryui-example-hide)
